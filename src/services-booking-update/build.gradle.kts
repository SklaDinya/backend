...
description = "services-booking-update"
group = "skladinya.services.booking-update"
...
tasks.jar {
    manifest {
        ...
        attributes["Bundle-Name"] = "SklaDinya Booking Update Service"
        attributes["Bundle-SymbolicName"] = archiveBaseName
    }
    archiveBaseName.set("skladinya-services-booking-update")
