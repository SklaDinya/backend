...
description = "services-operator"
group = "skladinya.services.operator"
...
tasks.jar {
    manifest {
        ...
        attributes["Bundle-Name"] = "SklaDinya Operator Service"
        attributes["Bundle-SymbolicName"] = archiveBaseName
    }
    archiveBaseName.set("skladinya-services-operator")
