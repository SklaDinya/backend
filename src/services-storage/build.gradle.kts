...
description = "services-storage"
group = "skladinya.services.storage"
...
tasks.jar {
    manifest {
        ...
        attributes["Bundle-Name"] = "SklaDinya Storage Service"
        attributes["Bundle-SymbolicName"] = archiveBaseName
    }
    archiveBaseName.set("skladinya-services-storage")
